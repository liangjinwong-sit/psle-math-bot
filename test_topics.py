...
print(f"\n✅ Topic-filtered retrieval returned {len(topic_filtered)} documents")
...
print("\n\n✅ Topic metadata working correctly!" if all(doc.metadata.get("topic") == topic for doc in topic_filtered) else "\n\n❌ Warning: Some documents don't have the expected topic")
